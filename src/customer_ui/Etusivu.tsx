      ...
      <Stack>
        <Box sx={{ marginTop: "10px" }}>
          ...
          <Stack fontFamily={"Montserrat"} style={{ border: "5px solid black", marginTop: "2px", backgroundColor: "white", marginBottom: "2px", width: "1140px", height: "700px", fontSize: "40px" }}>
            ...
            <Stack >
              <img style={{ marginTop: "0px", width: '1132px', height: '240px' }} src="https://www.xamkravintolat.fi/wp-content/uploads/sites/2/2017/02/talli_ylakuva.jpg" className="kuva" alt="logo" />
